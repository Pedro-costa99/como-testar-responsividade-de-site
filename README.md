...
<h4>💻 <a href="https://responsively.app/" target="_blank">Responsively</a> (Para visualizar layouts em várias resoluções de uma só vez, é a melhor aplicação. Necessita de instação no Pc. Aceita endereço localhost! )</h4> 
